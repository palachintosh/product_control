...
public class BarcodeGraphicTracker extends Tracker<Barcode> {
    private ui.camera.GraphicOverlay<BarcodeGraphic> mOverlay;
    ...
    BarcodeGraphicTracker(ui.camera.GraphicOverlay<BarcodeGraphic> mOverlay, BarcodeGraphic mGraphic,
                          Context context) {
